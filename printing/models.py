...
class Project(db.Model):
    ...
    packaging = db.Column(db.Float, default=0)
    advertising = db.Column(db.Float, default=0)
    rent = db.Column(db.Float, default=0)
    overhead = db.Column(db.Float, default=0)
    extrafees = db.Column(db.Float, default=0)
    discount = db.Column(db.Float)
    tracking = db.Column(db.Text)
    designhours = db.Column(db.Integer, default=0)
